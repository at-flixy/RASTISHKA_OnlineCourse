...
import { getAvailableCheckoutProviders, getCheckoutProviderSetupIssue } from "@/lib/payments/provider-meta";
...
export default async function CheckoutPage({ searchParams }: CheckoutPageProps) {
  ...
  const checkoutProvider = availableProviders.length > 0 ? initialProvider : "FREEDOMPAY";
      ...
      <div className="mx-auto max-w-6xl space-y-8 px-4 sm:px-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base text-muted-foreground sm:text-lg">
            Проверьте состав заказа, заполните данные и перейдите на защищенную страницу платежного
            провайдера.
          </p>
        </div>
